...
let
  baseConfig = builtins.readFile ./files/config.kdl;
  hostOverlay =
    if host.name == "nvidia-desktop" then builtins.readFile ./files/nvidia-desktop.kdl else "";
in
delib.module {
  name = "niri";
