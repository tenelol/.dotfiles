  ...
  home.always = {
    programs.fish = {
      ...
      shellAliases = {
        ...
        niri-extend = "niri msg output DP-3 on; niri msg output HDMI-A-1 on; niri msg output DP-3 mode 3840x2160@60.000; niri msg output HDMI-A-1 mode 1920x1080@165.000; niri msg output DP-3 scale 1.5; niri msg output HDMI-A-1 scale 1.0; niri msg output DP-3 position set 0 0; niri msg output HDMI-A-1 position set 2560 0";
      };
    };
