...
delib.module {
  ...
  home.always = {
    ...
    xdg.configFile."fish/functions/fish_prompt.fish".source = ./fish/files/functions/fish_prompt.fish;

    xdg.configFile."fish/functions/fish_greeting.fish".source =
      ./fish/files/functions/fish_greeting.fish;

    xdg.configFile."fish/functions/fish_right_prompt.fish".source =
      ./fish/files/functions/fish_right_prompt.fish;
  };
}
