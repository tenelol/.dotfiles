...
令和7年分（2025年）・令和8年分以後（令和8年度税制改正、令和8年〜12年入居）対応。
...
|------|------|
| 控除率 | 年末残高の**0.7%** |
| 控除期間 | 新築: **13年**、中古: **10年**（令和8年以後入居の認定・ZEH・省エネ基準適合の中古は**13年**） |
| 初年度 | **確定申告が必要** |
| 2年目以降 | 年末調整で適用可能 |

## 控除対象借入限度額（令和8年〜令和12年入居、令和8年度税制改正）

適用期限が令和12年12月31日まで5年延長された。中古住宅の拡充が最大の変更点。
...
| 省エネ基準適合住宅（令和8・9年入居） | 2,000万円 | 3,000万円 | 13年 |
| その他の住宅（省エネ基準未達） | 対象外 | 対象外 | — |

※ 令和10年以後入居の新築省エネ基準適合住宅は、建築確認が令和9年12月31日以前（または登記上の建築日が令和10年6月30日以前）の場合のみ「その他の住宅」として2,000万円・10年。
...
- 床面積40㎡以上50㎡未満の住宅も対象（合計所得金額1,000万円超の年は不適用）
- 子育て世帯（19歳未満の扶養親族あり）・若者夫婦世帯（夫婦いずれかが40歳未満）の上乗せを中古住宅にも新設
- 気候風土適応住宅を対象に追加
- 令和10年1月1日以後に建築確認を受ける ZEH水準未達の新築は対象外
- 災害危険区域等内の新築（令和10年以後入居）は原則対象外
